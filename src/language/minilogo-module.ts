 ...
 */
export type MiniLogoWorldServices  = LangiumServices & MiniLogoAddedServices
 ...
 */
export const MiniLogoModule: Module<MiniLogoWorldServices, PartialLangiumServices & MiniLogoAddedServices> = {
    validation: {
...
export function createMiniLogoServices(context: DefaultSharedModuleContext): {
    ...
    miniLogoServices: MiniLogoWorldServices
} {
    const shared = inject(
    ...
    return { shared, miniLogoServices: MiniLogo };
}
